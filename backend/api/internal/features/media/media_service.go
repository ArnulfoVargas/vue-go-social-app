...
func (m *mediaService) Upload(file *multipart.FileHeader) (*Media, error) {
...
func (m *mediaService) UploadMany(files []*multipart.FileHeader) ([]*Media, error) {
...
func (m *mediaService) DeleteManyByMedia(media []*Media) error {
